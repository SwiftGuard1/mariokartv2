...
function MarioKart() {
    var oMaps = {
        "map1": {
            "texture": "public_html/media/map_1.png",
            "width": 512,
            "height": 512,
            "collision": [
                [84, 80, 52, 216],
        ...
        "map2": {
            "texture": "public_html/media/map_2.png",
            "width": 512,
            "height": 512,
            "collision": [
                [120, 116, 8, 228],
    ...
    function startGame() {
        ...
        oCountImg.src = "public_html/media/countdown.png";
    ...
    function startMusic() {
        ...
        oMusicEmbed.src = "public_html/media/" + strMap + ".mid";
    ...
    function Sprite(strSprite) {
        ...
        oImg.style.left = "0px";
        oImg.src = "public_html/media/sprite_" + strSprite + (bSmoothSprites ? "_smooth" : "") + ".png";
    ...
    function BGLayer(strImage, iLayerWidth) {
        ...
        oImg1.src = "public_html/media/bg_" + strImage + ".png";
    ...
    function selectPlayerScreen() {
        ...
        oTitle.src = "public_html/media/title.png";
        ...
        for (var i = 0; i < aCharacters.length; i++) {
            ...
            oPImg.src = "public_html/media/select_" + aCharacters[i] + ".png";
    ...
    function selectMapScreen() {
        ...
        oContainer.appendChild(oScr);
        var oTitle = document.createElement("img");
        oTitle.src = "public_html/media/mushroomcup.png";
        oTitle.style.position = "absolute";
        ...
        for (var i = 0; i < aAvailableMaps.length; i++) {
            var oPImg = document.createElement("img");
            oPImg.src = "public_html/media/select_" + aAvailableMaps[i] + ".png";
    ...
    for (var i = 0; i < aCharacters.length; i++) {
        var oImg = new Image();
        oImg.src = "public_html/media/sprite_" + aCharacters[i] + "_smooth.png";
    }
